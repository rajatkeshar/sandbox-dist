...
private_.accounts = [], private_.accountsIndexById = {}, private_.executor = null, private_.addAccount = function(e, r) {
    ...
    delete(r || private_).accountsIndexById[e], (r || private_).accounts[t] = void 0
}, private_.getAccount = function(e, r) {
    var t = (r || private_).accountsIndexById[e];
    return (r || private_).accounts[t]
}, Accounts.prototype.clone = function(e) {
    var r = {
        data: extend(!0, {}, private_.accounts),
        index: extend(!0, {}, private_.accountsIndexById)
    };
    for (var t in r.data)
        for (var n in r.data[t].u_balance) r.data[t].u_balance[n] = r.data[t].balance[n] || 0;
    e(null, r)
}, Accounts.prototype.getExecutor = function(e) {
    var r = app.secret;
    if (!r) return (0, _setImmediate3.default)(e, "Secret is null");
    if (private_.executor) return (0, _setImmediate3.default)(e, null, private_.executor);
    ...
    a ? extend(a, e) : a = private_.addAccount(e, t), r(null, a)
    ...
    if (!a) {
        ...
        e.publicKey && (c.publicKey = e.publicKey), a = private_.addAccount(c, t)
    }(0, _keys2.default)(e).forEach(function(r) {
        var t = e[r];
        if ("number" == typeof t) a[r] = (a[r] || 0) + t;
        else if (util.isArray(t)) a[r] = applyDiff(a[r], t);
        else if ("object" == (void 0 === t ? "undefined" : (0, _typeof3.default)(t)))
            for (var n in t) a[r][n] = (a[r][n] || 0) + t[n]
    }), r(null, a)
    ...
    if (!a) {
        ...
        var t = e[r];
        if ("number" == typeof t) a[r] = (a[r] || 0) - t;
        else if (util.isArray(t)) t = reverseDiff(t), a[r] = applyDiff(a[r], t);
        else if ("object" == (void 0 === t ? "undefined" : (0, _typeof3.default)(t)))
            for (var n in t) a[r][n] = (a[r][n] || 0) - t[n]
    }), r(null, a)
    ...
    var t = this,
        n = e.query;
    if (!n.secret) return r("secret should not be empty");
    (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function e() {
        var a, c, u, i, s;
        return _regenerator2.default.wrap(function(e) {
            for (;;) switch (e.prev = e.next) {
                case 0:
                    return e.prev = 0, a = modules.api.crypto.keypair(n.secret), c = self.generateAddressByPublicKey(a.publicKey.toString("hex")), e.next = 5, app.model.Balance.findAll({
                        condition: {
                            address: c
                        },
                ...
                case 5:
                    return u = e.sent, e.next = 8, app.model.Account.findOne({
                        condition: {
                            address: c
                        }
                    });
                case 8:
                    ...
                    break;
                case 13:
                    e.prev = 13, e.t0 = e.catch(0), r("Server error: " + e.t0);
                case 16:
                case "end":
                    return e.stop()
            }
    ...
    var t = this;
    if (!e.params || !e.params.address) return r("Address should not be empty");
    (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function n() {
        var a, c;
        return _regenerator2.default.wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
                case 0:
                    return t.prev = 0, a = e.params.address, t.next = 4, app.model.Balance.findAll({
                        condition: {
                            address: a
                        },
                        fields: ["currency", "balance"]
                ...
                case 4:
                    ...
                    break;
                case 8:
                    t.prev = 8, t.t0 = t.catch(0), r("Server error: " + t.t0);
                case 11:
                case "end":
                    return t.stop()
            }
    ...
    (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function n() {
        ...
        return _regenerator2.default.wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
                ...
                case 4:
                    return c = t.sent, t.next = 7, app.model.Account.findOne({
                        condition: {
                            address: a
                        }
                    });
                case 7:
                    ...
                    break;
                case 12:
                    t.prev = 12, t.t0 = t.catch(0), r("Server error: " + t.t0);
                case 15:
                case "end":
                    return t.stop()
            }
